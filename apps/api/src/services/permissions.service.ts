...
const DEFAULT_PERMISSIONS: PermissionsConfig = {
  permissions: [
    ...
    { role: 'MANAGER' as UserRole, pages: ['products', 'service_orders', 'stock_reservations', 'purchase_budgets', 'goods_receipts', 'production_orders', 'production_batches', 'my_production', 'storage_locations', 'backup', 'supplier_orders', 'stock_adjustment', 'sellers', 'sales', 'separation', 'expedition', 'carriers'] as AppPage[] },
    ...
    { role: 'STOCK' as UserRole, pages: ['products', 'stock_reservations', 'goods_receipts', 'storage_locations', 'stock_adjustment', 'purchase_budgets', 'separation'] as AppPage[] },
    { role: 'EXPEDITION' as UserRole, pages: ['expedition', 'carriers'] as AppPage[] },
